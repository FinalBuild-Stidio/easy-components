...
const CheckCardGroup = (props) => {
  ...
  const domProps = omit$1(restProps, [
    "children",
    "defaultValue",
    "value",
    "disabled",
  ...
  if (type === "edit" || type === "update") {
    const dom = /* @__PURE__ */ jsx(
      TypedInputNumber,
      {
        ...
        ...omit$1(fieldProps, ["onChange", "onBlur"]),
...
function StepForm(stepNativeProps) {
  ...
  return /* @__PURE__ */ jsx(
    BaseForm,
    {
      ...
      layout: "vertical",
      ...omit$1(restProps, ["layoutType", "columns"])
    }
  );
}
  ...
  if (resetButtonProps !== false) {
    dom.push(
      /* @__PURE__ */ createElement(
        LoadingButton,
        {
          ...omit$1(resetButtonProps, ["preventDefault"]),
          key: "rest",
          onClick: (e) => {
  ...
  if (submitButtonProps !== false) {
    dom.push(
      /* @__PURE__ */ createElement(
        ...
        {
          variant: "contained",
          ...omit$1(submitButtonProps || {}, ["preventDefault"]),
          key: "submit",
          onClick: (e) => {
...
const Link = /*@__PURE__*/getDefaultExportFromCjs(link);
...
var clientHookInServerComponentError = {exports: {}};
...
} (clientHookInServerComponentError, clientHookInServerComponentError.exports));

var clientHookInServerComponentErrorExports = clientHookInServerComponentError.exports;
...
var hasRequiredNoSsrError;

function requireNoSsrError () {
	if (hasRequiredNoSsrError) return noSsrError;
	hasRequiredNoSsrError = 1;
	(function (exports) {
		Object.defineProperty(exports, "__esModule", {
		    value: true
		});
...
function requireBailoutToClientRendering () {
	...
	(function (module, exports) {
		...
		const _nossrerror = requireNoSsrError();
...
(function (module, exports) {
	...
	const _clienthookinservercomponenterror = clientHookInServerComponentErrorExports;
...
const SiderMenuWrapper = (props) => {
  ...
  const { token } = useContext(ProProvider);
  const omitProps = omit$1(props, ["className", "style"]);
...
const getFormConfigs = (isForm, formConfig) => {
  if (isForm) {
    return omit$1(formConfig, ["ignoreRules"]);
  }
