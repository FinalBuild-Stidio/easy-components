 ...
 */
export declare function useCacheToken<DerivativeToken = object, DesignToken = DerivativeToken>(theme: Theme<any, any>, tokens: Partial<DesignToken>[], option?: Option<DerivativeToken, DesignToken>): [DerivativeToken & {
    _tokenKey: string;
}, string];
export default useCacheToken;
