...
import type { SharedTimeProps } from 'rc-picker/lib/panels/TimePanel/index.js';
...
export declare function transPlacement2DropdownAlign(placement?: SelectCommonPlacement): AlignType;
...
export declare function mergeAllowClear(allowClear: AllowClear, clearIcon: ClearIcon, defaultClearIcon: NonNullable<ClearIcon>): false | {
    clearIcon: string | number | boolean | import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | Iterable<import("react").ReactNode> | import("react").PromiseLikeOfReactNode | null;
};
export {};
