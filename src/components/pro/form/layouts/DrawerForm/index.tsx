...
import type { DrawerProps, FormProps } from '@/components/base'
import { ConfigProvider, Drawer } from '@/components/base'
import {
  omitUndefined,
    ...
    return merge(
      {
        ...
        resetButtonProps: {
          ...
          onClick: (e: any) => {
            setOpen(false)
            // fix: #6006 點擊取消按鈕時,那麼必然會觸發抽屜關閉，我們無需在 此處重設表單，只需在抽屜關閉時重設即可
        ...
        <>
          <BaseForm<T, U>
            ...
            onFinish={async (values) => {
              ...
              // fix: #6006 如果 result 為 true,那麼必然會觸發抽屜關閉，我們無需在 此處重設表單，只需在抽屜關閉時重設即可
              return result
            }}
