...
import type { ProCardProps } from '@/components/pro/card'
import type { ProFieldEmptyText } from '@/components/pro/field'
import type {
  ProFormProps,
  QueryFilterProps,
} from '@/components/pro/form'
import type { TableProps } from '@/components/base'
...
import type { SearchProps } from '@/components/base/input'
import type {
  ColumnFilterItem,
  ColumnType,
  CompareFn,
  SortOrder,
} from '@/components/base/table/interface'
