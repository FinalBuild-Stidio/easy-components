...
import type { TableColumnType } from '@/components/base'
...
function renderDefaultOption<T>(
  ...
  return Object.keys(options)
    ...
    .map((key) => {
      ...
      if (optionItem) {
        return (
          <Tooltip key={key} title={optionItem.text}>
            <IconButton onClick={onClick}>{optionItem.icon}</IconButton>
          </Tooltip>
        )
      }
      return null
