...
import ProSkeleton from '@/components/pro/skeleton'
import type { DescriptionsProps, FormInstance, FormProps } from '@/components/base'
import { ConfigProvider, Descriptions, Space } from '@/components/base'
