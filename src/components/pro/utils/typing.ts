...
import type { CheckboxProps } from '@/components/base/checkbox'
import type { DatePickerProps } from '@/components/base/date-picker'
import type { InputProps, PasswordProps, TextAreaProps } from '@/components/base/input'
import type { InputNumberProps } from '@/components/base/input-number'
import type { RadioProps } from '@/components/base/radio'
import type { RangePickerProps } from '@/components/base/date-picker'
import type { SelectProps } from '@/components/base/select'
import type { SpaceProps } from '@/components/base/space'
import type { SwitchProps } from '@/components/base/switch'
import type { TimeRangePickerProps } from '@/components/base/time-picker'
import type { FormInstance, FormItemProps } from '@/components/base/form'
import type { LabelTooltipType } from '@/components/base/form/FormItemLabel'
...
> = {
  ...
  renderFormItem?: (
    ...
    form: FormInstance,
    action?: 'newLineRecord' | 'editableKeys' | 'actionRender' | 'setEditableRowKeys',
  ) => React.ReactNode
