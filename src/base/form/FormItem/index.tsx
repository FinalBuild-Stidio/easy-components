...
function InternalFormItem<Values = any>(props: FormItemProps<Values>): React.ReactElement {
  ...
  function renderLayout(
    ...
    return (
      <ItemHolder
        ...
        warnings={mergedWarnings}
        meta={meta}
        onSubItemMetaChange={onSubItemMetaChange as (meta: Meta, uniqueKeys: React.Key[]) => void}
      >
        {baseChildren}
      </ItemHolder>
    )
  ...
  return wrapSSR(
    ...
    >
      {(control, renderMeta, oriContext) => {
        const context = oriContext as FormInstance<Values>
        ...
        if (Array.isArray(mergedChildren) && hasName) {
          warning(
            false,
            'usage',
            'A `Form.Item` with a `name` prop must have a single child element. For information on how to render more complex form items.',
          )
